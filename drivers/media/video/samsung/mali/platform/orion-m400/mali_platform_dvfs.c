...
static unsigned int asv_3d_volt_5_table[ASV_5_LEVEL][MALI_DVFS_STEPS] = {
	/* L3 (100MHz) L2(160MHz), L1(250MHz) */
        {975000, 975000, 975000},	/* S */
	{975000, 975000, 975000},	/* A */
	{ 925000,  925000, 975000},	/* B */
	{ 925000,  925000, 975000},	/* C */
	{ 925000,  925000, 925000},	/* D */
};

static unsigned int asv_3d_volt_8_table[ASV_8_LEVEL][MALI_DVFS_STEPS] = {
	/* L3 (100MHz) L2(160MHz), L1(250MHz) */
        {975000, 975000, 975000},	/* SS */
	{975000, 975000, 975000},	/* A1 */
	{975000, 975000, 975000},	/* A2 */
	{ 925000,  925000, 975000},	/* B1 */
	{ 925000,  925000, 975000},	/* B2 */
	{ 925000,  925000, 975000},	/* C1 */
	{ 925000,  925000, 975000},	/* C2 */
	{ 925000,  925000, 925000},	/* D1 */
};
#elif defined(CONFIG_MACH_PX)
static unsigned int asv_3d_volt_5_table[ASV_5_LEVEL][MALI_DVFS_STEPS] = {
	/* L3 (160MHz) L2(200MHz), L1(250MHz) */
	{ 975000, 975000, 975000},	/* S */
	{ 975000, 975000, 975000},	/* A */
	{ 925000, 950000, 975000},	/* B */
	{ 925000, 950000, 975000},	/* C */
	{ 925000, 925000, 975000},	/* D */
};
...
static unsigned int asv_3d_volt_8_table[ASV_8_LEVEL][MALI_DVFS_STEPS] = {
	/* L3 (160MHz) L2(200MHz), L1(250MHz) */
        ...
        {975000, 975000, 975000},       /* A1 */
        {975000, 975000, 975000},       /* A2 */
        { 925000,  950000, 975000},     /* B1 */
        { 925000,  950000, 975000},     /* B2 */
        { 925000,  950000, 975000},     /* C1 */
        { 925000,  950000, 975000},     /* C2 */
        { 925000,  925000, 925000},     /* D1 */

};
#else
static unsigned int asv_3d_volt_5_table[ASV_5_LEVEL][MALI_DVFS_STEPS] = {
	/* L3 (66MHz) L2(160MHz), L1(250MHz) */
	{ 975000, 975000, 975000},      /* S */
	{ 975000, 975000, 975000},      /* A */
	{ 900000, 925000, 975000},      /* B */
	{ 900000, 925000, 975000},      /* C */
	{ 900000, 900000, 975000},      /* D */
};

static unsigned int asv_3d_volt_8_table[ASV_8_LEVEL][MALI_DVFS_STEPS] = {
	/* L3 (66MHz) L2(160MHz), L1(250MHz) */
        { 925000, 975000, 975000},	/* SS */
	{ 925000, 975000, 975000},	/* A1 */
	{ 925000, 975000, 975000},	/* A2 */
	{ 900000, 925000, 975000},	/* B1 */
	{ 900000, 925000, 975000},	/* B2 */
	{ 900000, 925000, 975000},	/* C1 */
	{ 900000, 925000, 975000},	/* C2 */
	{ 900000, 925000, 925000},	/* D1 */
};
#endif
#endif
